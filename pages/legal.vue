<template>
  ...
  import LoaderContent from '~/components/loader-content.vue';
  ...
  <style scoped>
  @import url('https://fonts.googleapis.com/css?family=IBM+Plex+Sans:500|IBM+Plex+Sans:300&display=swap');
  </style>
